...
#include <franka_example_controllers/cartesian_variable_impedance_controller.h>
...
void CartesianVariableImpedanceController::update(const ros::Time& /*time*/,
  ...
  // ROS_INFO_STREAM("Cartesian Stiffness Matrix:\n" << cartesian_stiffness_);
...
PLUGINLIB_EXPORT_CLASS(franka_example_controllers::CartesianVariableImpedanceController,
